...
def setup_main_routes(app):
    ...
    def fetch_recipient_ids(request: Request, current_user: Annotated[User, Depends(get_current_active_user)]):
    ...
    @app.get('/compute_similarities/{recipient_id}', tags=["data_science",  "authenticated"])
