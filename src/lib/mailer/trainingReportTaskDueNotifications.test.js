  ...
  it('handles invalid alert type', async () => {
    getTrainingReportAlerts.mockResolvedValue([
      // 20 days past event startDate: should send email
      {
        ...
        pocIds: [2],
        collaboratorIds: [3],
        startDate: DateTime.local().minus({ days: 20 }).toFormat('MM/dd/yyyy'),
        endDate: today,
      },
    ]);
  ...
  it('adds noSessionsCreated jobs to the queue', async () => {
    getTrainingReportAlerts.mockResolvedValue([
      // 20 days past event endDate: should send email
      {
        ...
        collaboratorIds: [3, 4],
        startDate: DateTime.local().minus({ days: 20 }).toFormat('MM/dd/yyyy'),
        endDate: DateTime.local().minus({ days: 20 }).toFormat('MM/dd/yyyy'),
      ...
      // 30 days past event endDate: don't send email
      {
        ...
        pocIds: [2],
        collaboratorIds: [3],
        startDate: DateTime.local().minus({ days: 30 }).toFormat('MM/dd/yyyy'),
        endDate: DateTime.local().minus({ days: 30 }).toFormat('MM/dd/yyyy'),
        eventStatus: TRAINING_REPORT_STATUSES.IN_PROGRESS,
        sessionId: false,
      },
      // 43 days past event enddate: don't send email
      {
        ...
        pocIds: [2],
        collaboratorIds: [3],
        startDate: DateTime.local().minus({ days: 43 }).toFormat('MM/dd/yyyy'),
        endDate: DateTime.local().minus({ days: 43 }).toFormat('MM/dd/yyyy'),
        eventStatus: TRAINING_REPORT_STATUSES.IN_PROGRESS,
        sessionId: false,
      },
      // 40 days past event end date: should send email
      {
        ...
        pocIds: [2],
        collaboratorIds: [3],
        startDate: DateTime.local().minus({ days: 40 }).toFormat('MM/dd/yyyy'),
        endDate: DateTime.local().minus({ days: 40 }).toFormat('MM/dd/yyyy'),
        eventStatus: TRAINING_REPORT_STATUSES.IN_PROGRESS,
        sessionId: false,
      },
      // 60 days past event enddate: should send email
      {
        ...
        pocIds: [2],
        collaboratorIds: [3],
        startDate: DateTime.local().minus({ days: 60 }).toFormat('MM/dd/yyyy'),
        endDate: DateTime.local().minus({ days: 60 }).toFormat('MM/dd/yyyy'),
        eventStatus: TRAINING_REPORT_STATUSES.IN_PROGRESS,
        sessionId: false,
      },
