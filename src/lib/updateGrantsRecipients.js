...
export async function processFiles(hashSumHex) {
  try {
    await sequelize.transaction(async (transaction) => {
      ...
      const agency = parser.parse(agencyData);
      ...
      const grant = parser.parse(grantData);
      ...
      const programs = parser.parse(programData);
      ...
      const grantReplacementsJson = parser.parse(grantReplacementsData);
