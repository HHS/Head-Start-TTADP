...
import { beforeCreate, beforeUpdate } from './hooks/monitoringStandard'
...
export default (sequelize, DataTypes) => {
  class MonitoringStandard extends Model {
    static associate(models) {
      ...
      models.MonitoringStandardLink.hasMany(models.MonitoringStandard, {
        foreignKey: 'standardId',
        as: 'monitoringStandards',
      })

      models.MonitoringStandard.belongsTo(models.MonitoringStandardLink, {
        foreignKey: 'standardId',
        as: 'standardLink',
      })
    }
