...
const { beforeValidate, beforeUpdate, afterCreate, afterUpdate } = require('./hooks/goalTemplate')
...
export default (sequelize, DataTypes) => {
  class GoalTemplate extends Model {
    ...
    static associate(models) {
      ...
      GoalTemplate.hasMany(models.GoalTemplateObjectiveTemplate, {
        foreignKey: 'goalTemplateId',
        as: 'goalTemplateObjectiveTemplates',
      })
      GoalTemplate.hasMany(models.GoalTemplateFieldPrompt, {
        foreignKey: 'goalTemplateId',
        as: 'prompts',
      })
      GoalTemplate.hasMany(models.GoalTemplateResource, {
        foreignKey: 'goalTemplateId',
      ...
      GoalTemplate.hasMany(models.CollabReportGoal, {
        foreignKey: 'goalTemplateId',
        as: 'collabReportGoals',
      })
      // Session Report Pilot Goal Templates.
      GoalTemplate.hasMany(models.SessionReportPilotGoalTemplate, {
        foreignKey: 'goalTemplateId',
        as: 'sessionReportGoalTemplates',
      })
