...
const { beforeCreate, beforeUpdate, afterCreate, afterUpdate, beforeValidate, afterDestroy } = require('./hooks/activityReport')
        ...
        validate: {
          checkRequiredForSubmission() {
            ...
            if (this.deliveryMethod === 'hybrid') {
              requiredForSubmission = [this.numberOfParticipantsInPerson, this.numberOfParticipantsVirtually, ...requiredForSubmission]
            } else {
              requiredForSubmission = [this.numberOfParticipants, ...requiredForSubmission]
            }
