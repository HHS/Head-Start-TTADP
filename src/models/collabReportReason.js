...
export default (sequelize, DataTypes) => {
  class CollabReportReason extends Model {
    static associate(models) {
      CollabReportReason.belongsTo(models.CollabReport, {
  ...
  CollabReportReason.init(
    {
      ...
      reasonId: {
        allowNull: false,
        type: DataTypes.ENUM(['participate_work_groups', 'support_coordination', 'agg_regional_data', 'develop_presentations']),
      },
    },
    {
      sequelize,
