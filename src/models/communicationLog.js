...
export default (sequelize, DataTypes) => {
  class CommunicationLog extends Model {
    static associate(models) {
      ...
      CommunicationLog.hasMany(models.CommunicationLogFile, {
        foreignKey: 'communicationLogId',
        as: 'communicationLogFiles',
      });
      CommunicationLog.hasMany(models.CommunicationLogRecipient, {
        foreignKey: 'communicationLogId',
        as: 'communicationLogRecipients',
      });
      CommunicationLog.hasMany(models.CommunicationLogStaff, {
        foreignKey: 'communicationLogId',
