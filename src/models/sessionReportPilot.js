...
const { afterCreate, afterUpdate, beforeCreate, beforeUpdate, beforeDestroy } = require('./hooks/sessionReportPilot')
  ...
  SessionReportPilot.init(
    {
      ...
      submitted: {
        ...
        get() {
          return !!(this.approverId && this.data && this.data.pocComplete && this.data.collabComplete)
        },
      },
    },
    {
