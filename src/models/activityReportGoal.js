...
const { afterCreate, beforeDestroy, afterDestroy, afterUpdate, beforeValidate } = require('./hooks/activityReportGoal')

export default (sequelize, DataTypes) => {
  class ActivityReportGoal extends Model {
    static associate(models) {
      ActivityReportGoal.belongsTo(models.ActivityReport, {
        foreignKey: 'activityReportId',
        as: 'activityReport',
      })
      ActivityReportGoal.belongsTo(models.Goal, { foreignKey: 'goalId', as: 'goal' })
      ActivityReportGoal.hasMany(models.ActivityReportGoalResource, {
        foreignKey: 'activityReportGoalId',
        as: 'activityReportGoalResources',
      })
      ActivityReportGoal.hasMany(models.ActivityReportGoalFieldResponse, {
        foreignKey: 'activityReportGoalId',
