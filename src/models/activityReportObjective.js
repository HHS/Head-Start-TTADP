...
const { afterCreate, beforeValidate, beforeDestroy, afterDestroy } = require('./hooks/activityReportObjective')

export default (sequelize, DataTypes) => {
  class ActivityReportObjective extends Model {
    static associate(models) {
      ActivityReportObjective.belongsTo(models.ActivityReport, {
      ...
      ActivityReportObjective.hasMany(models.ActivityReportObjectiveFile, {
        foreignKey: 'activityReportObjectiveId',
        as: 'activityReportObjectiveFiles',
      })
      ActivityReportObjective.hasMany(models.ActivityReportObjectiveTopic, {
        foreignKey: 'activityReportObjectiveId',
        as: 'activityReportObjectiveTopics',
      })
      ActivityReportObjective.hasMany(models.ActivityReportObjectiveResource, {
        foreignKey: 'activityReportObjectiveId',
        as: 'activityReportObjectiveResources',
      })
      ActivityReportObjective.hasMany(models.ActivityReportObjectiveCourse, {
        foreignKey: 'activityReportObjectiveId',
