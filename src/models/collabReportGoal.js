...
export default (sequelize, DataTypes) => {
  class CollabReportGoal extends Model {
    static associate(models) {
      CollabReportGoal.belongsTo(models.CollabReport, {
        foreignKey: 'collabReportId',
        as: 'collabReport',
      });
      CollabReportGoal.belongsTo(models.GoalTemplate, {
  ...
  CollabReportGoal.init(
    {
      ...
      goalTemplateId: {
        ...
        comment:
          'The actual value a user chooses is a string that is from the GoalTemplates.standard column',
      },
    },
    {
      sequelize,
