...
module.exports = {
  up: async (queryInterface, Sequelize) =>
    queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.addColumn('Goals', 'createdVia', { type: Sequelize.DataTypes.ENUM(createdViaSources), allowNull: true }, { transaction })
  ...
  down: async (queryInterface) =>
    queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.removeColumn('Goals', 'createdVia', { transaction })
