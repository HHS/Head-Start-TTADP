...
module.exports = {
  ...
  down: async (queryInterface) =>
    queryInterface.sequelize.transaction(async (transaction) => {
      ...
      const query =
        'INSERT INTO "Recipients"(id, "name", "createdAt", "updatedAt", "recipientType") VALUES (5, \'Arkansas Department of Human Services\', \'2021-03-16T01:34:16.558Z\', \'2021-03-16T01:34:16.558Z\', \'Government Agency (Non-CAA)\');';

      await queryInterface.sequelize.query(query, { transaction });
      await queryInterface.sequelize.query(
        'UPDATE "Grants" SET "recipientId" = 5 WHERE "id" = 9957;',
        { transaction }
      );
      await queryInterface.sequelize.query(
