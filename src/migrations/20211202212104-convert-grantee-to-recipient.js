...
module.exports = {
  up: async (queryInterface) => {
    ...
    return queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query(
        'ALTER TABLE "Grants" RENAME CONSTRAINT "Grants_granteeId_fkey" TO "Grants_recipientId_fkey";',
        { transaction }
      );
      ...
      await queryInterface.sequelize.query(
        'UPDATE "NextSteps" SET "noteType" = \'RECIPIENT\' WHERE "noteType" = \'GRANTEE\';',
        { transaction }
      );
      ...
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "reason" = ARRAY_REPLACE("reason", \'New Grantee\', \'New Recipient\');',
        { transaction }
      );

      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "requester" = \'regionalOffice\' WHERE "requester" = \'Regional Office\';',
        { transaction }
      );
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "requester" = \'recipient\' WHERE "requester" = \'Grantee\';',
        { transaction }
      );
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "requester" = \'recipient\' WHERE "requester" = \'grantee\';',
  ...
  down: async (queryInterface) => {
    ...
    return queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query(
        'ALTER TABLE "Grants" RENAME CONSTRAINT "Grants_recipientId_fkey" TO "Grants_granteeId_fkey";',
        { transaction }
      );
       ...
       */
      await queryInterface.sequelize.query(
        'UPDATE "NextSteps" SET "noteType" = \'GRANTEE\' WHERE "noteType" = \'RECIPIENT\';',
        { transaction }
      );
      ...
      await queryInterface.renameColumn('Grantees', 'recipientType', 'granteeType', {
        transaction,
      });
      ...
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "reason" = ARRAY_REPLACE("reason", \'New Recipient\', \'New Grantee\');',
        { transaction }
      );

      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "requester" = \'grantee\' WHERE "requester" = \'recipient\';',
        { transaction }
      );
