...
module.exports = {
  up: async (queryInterface) => {
    ...
    return queryInterface.sequelize.transaction(async (transaction) => {
       ...
       */
      await queryInterface.renameColumn('ActivityRecipients', 'nonGranteeId', 'otherEntityId', {
        transaction,
      })
      await queryInterface.sequelize.query(
        'ALTER TABLE "ActivityRecipients" RENAME CONSTRAINT "ActivityParticipants_nonGranteeId_fkey" TO "ActivityRecipients_otherEntityId";',
        { transaction }
      )
      ...
      await queryInterface.sequelize.query('ALTER TABLE "Grants" RENAME CONSTRAINT "Grants_granteeId_fkey" TO "Grants_recipientId_fkey";', {
        transaction,
      })
      ...
      await queryInterface.renameColumn('Recipients', 'granteeType', 'recipientType', {
        transaction,
      })
       ...
       */
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "activityRecipientType" = \'recipient\' WHERE "activityRecipientType" = \'grantee\';',
        { transaction }
      )
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "activityRecipientType" = \'other-entity\' WHERE "activityRecipientType" = \'non-grantee\';',
        { transaction }
      )

      await queryInterface.sequelize.query(
        "UPDATE \"ActivityReports\" SET \"activityRecipientType\" = 'recipient' WHERE \"activityRecipientType\" = 'nonGrantee' and imported->>'nonGranteeActivity' = '';",
        { transaction }
      )
      await queryInterface.sequelize.query(
        "UPDATE \"ActivityReports\" SET \"activityRecipientType\" = 'other-entity' WHERE \"activityRecipientType\" = 'nonGrantee' and imported->>'nonGranteeActivity' != '';",
        { transaction }
      )

      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "reason" = ARRAY_REPLACE("reason", \'New Grantee\', \'New Recipient\');', {
        transaction,
      })

      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "requester" = \'regionalOffice\' WHERE "requester" = \'Regional Office\';', {
        transaction,
      })
      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "requester" = \'recipient\' WHERE "requester" = \'Grantee\';', {
        transaction,
      })
      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "requester" = \'recipient\' WHERE "requester" = \'grantee\';', {
        transaction,
      ...
      await queryInterface.sequelize.query(
        'ALTER TABLE "GrantGoals" RENAME CONSTRAINT "GrantGoals_granteeId_fkey" TO "GrantGoals_recipientId_fkey";',
        { transaction }
      )
    })
  },
  ...
  down: async (queryInterface) => {
    ...
    return queryInterface.sequelize.transaction(async (transaction) => {
       ...
       */
      await queryInterface.renameColumn('ActivityRecipients', 'otherEntityId', 'nonGranteeId', {
        transaction,
      })
      await queryInterface.sequelize.query(
        'ALTER TABLE "ActivityRecipients" RENAME CONSTRAINT "ActivityRecipients_otherEntityId" TO "ActivityParticipants_nonGranteeId_fkey";',
        { transaction }
      )
      ...
      await queryInterface.sequelize.query('ALTER TABLE "Grants" RENAME CONSTRAINT "Grants_recipientId_fkey" TO "Grants_granteeId_fkey";', {
        transaction,
      })
       ...
       */
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "activityRecipientType" = \'grantee\' WHERE "activityRecipientType" = \'recipient\';',
        { transaction }
      )
      await queryInterface.sequelize.query(
        'UPDATE "ActivityReports" SET "activityRecipientType" = \'non-grantee\' WHERE "activityRecipientType" = \'other-entity\';',
        { transaction }
      )

      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "reason" = ARRAY_REPLACE("reason", \'New Recipient\', \'New Grantee\');', {
        transaction,
      })

      await queryInterface.sequelize.query('UPDATE "ActivityReports" SET "requester" = \'grantee\' WHERE "requester" = \'recipient\';', {
        transaction,
      })
      ...
      await queryInterface.sequelize.query(
        'ALTER TABLE "GrantGoals" RENAME CONSTRAINT "GrantGoals_recipientId_fkey" TO "GrantGoals_granteeId_fkey";',
        { transaction }
      )
    })
  },
