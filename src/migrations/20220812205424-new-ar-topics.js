...
const topicMapping = [
  {
    oldName: 'Child Assessment, Development, Screening',
    newName: 'Child Screening and Assessment',
  },
  {
    oldName: 'Teaching Practices / Teacher-Child Interactions',
    newName: 'Teaching / Caregiving Practices',
  },
]
...
module.exports = {
  async up(queryInterface) {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await Promise.all(
        topicMapping.map(({ oldName, newName }) =>
