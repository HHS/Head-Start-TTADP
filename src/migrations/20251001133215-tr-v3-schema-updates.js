...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.addIndex('SessionReportPilotTrainers', ['sessionReportPilotId', 'userId'], {
        unique: true,
      ...
      // Add unique constraint
      await queryInterface.addIndex('SessionReportPilotGrants', ['sessionReportPilotId', 'grantId'], {
        unique: true,
      ...
      // Add unique constraint
      await queryInterface.addIndex('SessionReportPilotGoalTemplates', ['sessionReportPilotId', 'goalTemplateId'], {
        unique: true,
