module.exports = {
  up: (queryInterface) => queryInterface.sequelize.transaction((transaction) => Promise.all([
    ...
    queryInterface.addIndex('ActivityReportObjectiveResources', ['userProvidedUrl'], { transaction }),
    ...
    queryInterface.addIndex('ObjectiveTemplateFiles', ['objectiveTemplateId', 'fileId'], { transaction }),
    ...
    queryInterface.addIndex('GoalTemplateObjectiveTemplates', ['objectiveTemplateId'], { transaction }),
  ...
  down: (queryInterface) => queryInterface.sequelize.transaction((transaction) => Promise.all([
    ...
    queryInterface.removeIndex('ActivityReportObjectiveResources', ['userProvidedUrl'], { transaction }),
    ...
    queryInterface.removeIndex('ObjectiveTemplateFiles', ['objectiveTemplateId', 'fileId'], { transaction }),
    ...
    queryInterface.removeIndex('GoalTemplateObjectiveTemplates', ['objectiveTemplateId'], { transaction }),
