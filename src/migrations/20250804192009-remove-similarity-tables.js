  ...
  async up(queryInterface) {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.sequelize.query(
        'DROP FUNCTION IF EXISTS "public"."ZALNoUpdateFGoalSimilarityGroupGoals" ()',
        { transaction }
      );
      await queryInterface.sequelize.query(
        'DROP FUNCTION IF EXISTS "public"."ZALNoTruncateFGoalSimilarityGroupGoals" ()',
        { transaction }
      );
      await queryInterface.sequelize.query(
        'DROP FUNCTION IF EXISTS "public"."ZALNoDeleteFGoalSimilarityGroupGoals" ()',
        { transaction }
      );
