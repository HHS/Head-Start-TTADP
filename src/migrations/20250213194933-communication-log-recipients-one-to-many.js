...
module.exports = {
  ...
  down: async (queryInterface) =>
    queryInterface.sequelize.transaction(async (transaction, Sequelize) => {
      await prepMigration(queryInterface, transaction, __filename)
      ...
      await queryInterface.sequelize.query(
        'UPDATE "CommunicationLogs" cl SET "recipientId" = clr."recipientId" FROM "CommunicationLogRecipient" clr WHERE cl.id = clr."communicationLogId"',
        { transaction }
      )
