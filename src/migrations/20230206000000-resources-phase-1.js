    ...
    queryInterface.sequelize.transaction(async (transaction) => {
        ...
        'ActivityReportResources',
        {
          ...
          sourceFields: {
            ...
            type: Sequelize.DataTypes.ARRAY(
              Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.REPORT))
            ),
          },
          createdAt: {
            allowNull: false,
      ...
      await queryInterface.createTable(
        'NextStepResources',
        {
          ...
          sourceFields: {
            ...
            default: null,
            type: Sequelize.DataTypes.ARRAY(
              Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.NEXTSTEPS))
            ),
          },
          createdAt: {
            allowNull: false,
      ...
      await queryInterface.createTable(
        'GoalResources',
        {
          ...
          sourceFields: {
            ...
            default: null,
            type: Sequelize.DataTypes.ARRAY(
              Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.GOAL))
            ),
          },
          createdAt: {
            allowNull: false,
      ...
      await queryInterface.createTable(
        'GoalTemplateResources',
        {
          ...
          sourceFields: {
            ...
            default: null,
            type: Sequelize.DataTypes.ARRAY(
              Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.GOALTEMPLATE))
            ),
          },
          createdAt: {
            allowNull: false,
      ...
      await queryInterface.createTable(
        'ActivityReportGoalResources',
        {
          ...
          sourceFields: {
            ...
            default: null,
            type: Sequelize.DataTypes.ARRAY(
              Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.REPORTGOAL))
            ),
          },
          createdAt: {
            allowNull: false,
      ...
      await queryInterface.addColumn(
        ...
        'sourceFields',
        {
          ...
          default: null,
          type: Sequelize.DataTypes.ARRAY(
            Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.OBJECTIVE))
          ),
        },
        { transaction }
      );
      ...
      await queryInterface.addColumn(
        ...
        'sourceFields',
        {
          ...
          default: null,
          type: Sequelize.DataTypes.ARRAY(
            Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.OBJECTIVETEMPLATE))
          ),
        },
        { transaction }
      );
      ...
      await queryInterface.addColumn(
        ...
        'sourceFields',
        {
          ...
          default: null,
          type: Sequelize.DataTypes.ARRAY(
            Sequelize.DataTypes.ENUM(Object.values(SOURCE_FIELD.REPORTOBJECTIVE))
          ),
        },
        { transaction }
      );
