...
module.exports = {
  up: async (queryInterface, Sequelize) => queryInterface.sequelize.transaction(
    async (transaction) => {
      ...
      await queryInterface.renameColumn('Objectives', 'suspendContext', 'closeSuspendContext', { transaction });
  ...
  down: async (queryInterface) => queryInterface.sequelize.transaction(
    async (transaction) => {
      const sessionSig = __filename;
      await prepMigration(queryInterface, transaction, sessionSig);
      await queryInterface.renameColumn('Objectives', 'closeSuspendReason', 'suspendReason', { transaction });
      await queryInterface.renameColumn('Objectives', 'closeSuspendContext', 'suspendContext', { transaction });
      await queryInterface.renameColumn('Objectives', 'closeSuspendReason', 'suspendReason', { transaction });
      return queryInterface.renameColumn('Objectives', 'closeSuspendContext', 'suspendContext', { transaction });
    },
  ),
};
