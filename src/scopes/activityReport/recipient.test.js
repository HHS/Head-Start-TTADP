  ...
  describe('recipient', () => {
    ...
    describe('single or multi recipient', () => {
      ...
      beforeAll(async () => {
        ...
        recipientIds = [multiRecipient1.id, multiRecipient2.id, singleRecipient.id, singleRecipient2.id, excludedRecipient.id]
        ...
        grantIds = [multiRecipientGrant1.id, multiRecipientGrant2.id, singleRecipientGrant.id, singleRecipientGrant2.id, excludedGrant.id]
      ...
      it('retrieves reports with one recipient', async () => {
        ...
        expect(found.length).toBe(2)
        expect(found.map((f) => f.id)).toEqual(expect.arrayContaining([singleRecipientReport.id, excludedReport.id]))
      })
    })
