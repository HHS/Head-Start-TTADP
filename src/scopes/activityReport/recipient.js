...
export function withRecipientName(names) {
  return {
    [Op.or]: [filterAssociation(recipientName, names, false), filterAssociation(otherEntityName, names, false)],
  }
}

export function withoutRecipientName(names) {
  return {
    [Op.and]: [filterAssociation(recipientName, names, true), filterAssociation(otherEntityName, names, true)],
  }
}
