...
describe('grants/activeWithin', () => {
  ...
  it('before', async () => {
    ...
    expect(found.map((f) => f.id)).toEqual(expect.arrayContaining([recipients[0].id, recipients[4].id, recipients[5].id]))
  })
  ...
  it('after', async () => {
    ...
    expect(found.length).toBe(3)
    expect(found.map((f) => f.id)).toEqual(expect.arrayContaining([recipients[1].id, recipients[2].id, recipients[3].id]))
  })
  ...
  it('after plus inactivation date', async () => {
    ...
    expect(found.map((f) => f.id)).toEqual(
      expect.arrayContaining([recipients[1].id, recipients[2].id, recipients[3].id, recipients[4].id, recipients[5].id])
    )
  })
  ...
  it('within', async () => {
    ...
    expect(found.map((f) => f.id)).toEqual(expect.arrayContaining([recipients[1].id, recipients[2].id]))
  })
  ...
  it('within plus inactivation date', async () => {
    ...
    expect(found.length).toBe(2)
    expect(found.map((f) => f.id)).toEqual(expect.arrayContaining([recipients[4].id, recipients[5].id]))
  })
})
