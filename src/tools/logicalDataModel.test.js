...
import logicalDataModel, { isCamelCase, processEnum, processClassDefinition, processAssociations, writeUml } from './logicalDataModel'
...
describe('logicalDataModel', () => {
  ...
  describe('processAssociations', () => {
    ...
    it('should handle "defined both directions" associations', () => {
      const associations = [{ source: { name: 'Order' }, target: { name: 'Product' }, associationType: 'hasMany' }]
