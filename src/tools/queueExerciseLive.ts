...
import { generateS3Config, uploadFile, downloadFile, deleteFileFromS3 } from '../lib/s3'
      ...
      try {
        ...
        if (soakFlow.redisBefore && soakFlow.redisAfter) {
          ...
          const blockedClientsDelta =
            soakFlow.redisAfter.clients.blockedClients - soakFlow.redisBefore.clients.blockedClients
