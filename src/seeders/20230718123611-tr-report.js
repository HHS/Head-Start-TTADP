...
module.exports = {
  async up(queryInterface) {
    ...
    SELECT
      id,
      1,
      CAST('{"sessionName":"School Readiness Workshop - National Center","reviewStatus": "draft","startDate":"2024-02-03","endDate":"2024-02-03","duration":4,"deliveryMethod":"in-person","context":"Specialized school readiness assessment","objective":"Master assessment techniques","numberOfParticipants":25,"status":"In progress","collabComplete":false,"pocComplete":false,"regionId":3,"facilitation":"national_center","recipients":[{"value":1235,"label":"Example Recipient 2"}],"objectiveTopics":["School Readiness","Assessment","Child Development"],"objectiveTrainers":["NCQTL"],"participants":["Teacher","Coach"],"additionalStates":[],"reviewStatus":"draft"}' AS JSONB),
      NOW(),
      NOW()
