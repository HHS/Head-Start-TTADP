...
export async function resourceData(scopes) {
  ...
  // console.log(reports[0].activityReportResources);
  let reportResources;
  try {
    ...
    // const resourceReports = reportResources.reduce((resources, report) => {
    //   console.log(report);
    //   // report.resources.reduce((rResources, resource) => {
    //   //   const existing = rResources.find((r) => r.id === resource.dataValues.id);
    //   //   if (existing) {
    //   //     const dupReport = existing.reports.find((r) => r.id === report.id);
    //   //     if (!dupReport) {
    ...
    //   //     ...rResources,
    //   //     {
    //   //       ...resource.dataValues, // id, url, domain
    //   //       reports: [
    //   //         {
    //   //           id: report.id,
    //   //           numberOfParticipants: report.numberOfParticipants,
