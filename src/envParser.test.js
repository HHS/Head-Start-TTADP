...
describe('envParser', () => {
  describe('getEnvNumber', () => {
    ...
    it('should reject decimals when requireInteger is true', () => {
      ...
      expect(() => getEnvNumber('TEST_VAR', 42, { requireInteger: true })).toThrow('TEST_VAR must be an integer, got: 1.5')
    })
    ...
    it('should reject scientific notation with requireInteger when result is not integer', () => {
      ...
      expect(() => getEnvNumber('TEST_VAR', 42, { requireInteger: true })).toThrow('TEST_VAR must be an integer, got: 1e-3')
    })
  })
})
