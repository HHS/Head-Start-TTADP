...
const feedUrl = 'https://acf-ohs.atlassian.net/wiki/createrssfeed.action?types=page&types=blogpost&spaces=OHSTTA&title=Confluence+RSS+Feed&labelString%3D&excludedSpaceKeys=CSTTA&sort=modified&maxResults=2&timeSpan=5&showContent=true&confirm=Create+RSS+Feed&os_authType=basic';
