...
import db, { ActivityReportApprover, ActivityReport, Permission, User } from '../../models'
  ...
  it('creates new approvers', async () => {
    ...
    expect(mockResponse.json).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        approvers: [expect.objectContaining({ status: null, note: null }), expect.objectContaining({ status: null, note: null })],
      })
    )
  })
