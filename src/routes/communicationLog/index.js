...
import { checkIdIdParam, checkRecipientIdParam, checkRegionIdParam } from '../../middleware/checkIdParamMiddleware'

const router = express.Router()
const context = 'communicationLog'

router.post('/region/:regionId', checkRegionIdParam, transactionWrapper(createLogByRegionId, `${context} /region/:regionId`))
router.get(
