...
import { collabReportById, createOrUpdateReport, deleteReport, orderCollabReportsBy, collabReportScopes, getCSVReports } from './collabReports'
...
describe('Collab Reports Service', () => {
  beforeAll(async () => {
    ...
    await Promise.all([User.create(mockUser), User.create(mockUserTwo), User.create(mockUserThree)])
  })
  ...
  describe('deleteReport', () => {
    ...
    it('successfully deletes a report with comprehensive related data', async () => {
      ...
      const softDeleted = await CollabReport.findByPk(testReportWithRelatedData.id, { paranoid: false })
  ...
  describe('getCSVReports', () => {
    ...
    it('includes collaborating specialists with roles', async () => {
      ...
      const reportWithSpecialists = result.find((r) => r.collaboratingSpecialists && r.collaboratingSpecialists.length > 0)
          ...
          steps: [
            {
              ...
              toJSON() {
                return { collabStepDetail: 'First step completed', collabStepCompleteDate: '2020-09-01' }
              },
            },
            {
              ...
              toJSON() {
                return { collabStepDetail: 'Second step completed', collabStepCompleteDate: '2020-09-02' }
              },
            },
          ],
        }
          ...
          steps: [
            {
              ...
              collabStepCompleteDate: '2020-09-01',
              toJSON() {
                return { collabStepDetail: this.collabStepDetail, collabStepCompleteDate: this.collabStepCompleteDate }
              },
            },
            {
