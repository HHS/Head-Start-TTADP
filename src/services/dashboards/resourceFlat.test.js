...
import { resourceFlatData, rollUpResourceUse, rollUpTopicUse, restructureOverview } from './resource'
...
describe('Resources dashboard', () => {
  beforeAll(async () => {
    ...
    await processActivityReportObjectiveForResourcesById(activityReportOneObjectiveTwo.id, [HEADSTART_RESOURCE_URL, NON_HEADSTART_RESOURCE_URL])
    ...
    await processActivityReportObjectiveForResourcesById(activityReportObjectiveTwo.id, [HEADSTART_RESOURCE_URL, HEADSTART_RESOURCE_URL2])
    ...
    await processActivityReportObjectiveForResourcesById(activityReportObjectiveThree.id, [NON_HEADSTART_RESOURCE_URL, HEADSTART_RESOURCE_URL2])
    ...
    await processActivityReportObjectiveForResourcesById(activityReportObjectiveForReport4.id, [HEADSTART_RESOURCE_URL2])
    ...
    await processActivityReportObjectiveForResourcesById(activityReportObjectiveDraft.id, [HEADSTART_RESOURCE_URL, NON_HEADSTART_RESOURCE_URL])
  ...
  it('overviewFlat', async () => {
    ...
    await db.sequelize.transaction(async () => {
      ...
      const { numberOfParticipants, numberOfRecipients, pctOfReportsWithResources, pctOfHeadStartResources } = overView
