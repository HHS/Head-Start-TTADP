...
import db, { User, Recipient, CommunicationLog, CommunicationLogRecipient, CommunicationLogFile, File } from '../models'
import {
  logById,
...
describe('communicationLog services', () => {
  ...
  describe('orderLogsBy', () => {
    ...
    it('should return the correct result when sortBy is PURPOSE', () => {
      ...
      expect(result).toEqual([[sequelize.literal("data->>'purpose' DESC")], [sequelize.col('id'), 'DESC']])
    })
    ...
    it('should return the correct result when sortBy is RESULT', () => {
      ...
      expect(result).toEqual([[sequelize.literal("data->>'result' ASC")], [sequelize.col('id'), 'ASC']])
    })
    ...
    it('should return the correct result when sortBy is DATE', () => {
      ...
      expect(result).toEqual([[sequelize.literal("(NULLIF(data ->> 'communicationDate',''))::DATE DESC")], [sequelize.col('id'), 'DESC']])
    })
    ...
    it('should return the correct result when sortBy is not provided', () => {
      ...
      expect(result).toEqual([[sequelize.literal("(NULLIF(data ->> 'communicationDate',''))::DATE ASC")], [sequelize.col('id'), 'ASC']])
    })
  ...
  describe('formatCommunicationDateWithJsonData', () => {
    const badDatesLong = ['08/16/24', '8/16/24', '8/16/2024', '08/16//24', '8-16-24', '08/16/20240.75']
