...
describe('Notification service', () => {
  ...
  describe('deleteNotification', () => {
    it('destroys notifications matching the given scopes and cascades state rows', async () => {
      ...
      await NotificationUserState.bulkCreate([
        {
          notificationId: matchingOne.id,
          userId: user.id,
          archivedAt: null,
          viewedAt: '2026-04-01',
        },
        {
          notificationId: matchingTwo.id,
          userId: user.id,
          archivedAt: null,
          viewedAt: '2026-04-02',
        },
      ...
      const remainingStates = await NotificationUserState.findAll({
        where: { notificationId: [matchingOne.id, matchingTwo.id, otherNotification.id] },
      });
