...
const processResourceQueue = () => {
  ...
  resourceQueue.process(RESOURCE_ACTIONS.GET_METADATA, transactionQueueWrapper(getResourceMetaDataJob, RESOURCE_ACTIONS.GET_METADATA))
}

export { resourceQueue, addGetResourceMetadataToQueue, onFailedResourceQueue, onCompletedResourceQueue, processResourceQueue }
