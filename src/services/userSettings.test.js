...
describe('UserSetting service', () => {
  ...
  describe('saveSettings', () => {
    ...
    it('properly updates an override', async () => {
      ...
      // ascending order.
      expect(found.sort((a, b) => a.key.localeCompare(b.key))).toEqual(expected.sort((a, b) => a.key.localeCompare(b.key)))
      ...
      // ascending order.
      expect(found2.sort((a, b) => a.key.localeCompare(b.key))).toEqual(expected2.sort((a, b) => a.key.localeCompare(b.key)))
    })
    ...
    it('properly deletes an override', async () => {
      ...
      // ascending order.
      expect(found2.sort((a, b) => a.key.localeCompare(b.key))).toEqual(defs.sort((a, b) => a.key.localeCompare(b.key)))
    })
  ...
  describe('userSettingOverridesById', () => {
    it("returns the value when there's an override", async () => {
      ...
      await saveSettings(999, setting)
      const found = await userSettingOverridesById(999, USER_SETTINGS.EMAIL.KEYS.COLLABORATOR_ADDED)
