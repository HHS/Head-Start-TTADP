...
export default function RegionalDashboardReviewWithinCitation({ review, regionId }) {
  return (
    <div>
      <DescriptionList>
        <DescriptionItem title="Review name">{review.name}</DescriptionItem>
        <DescriptionItem title="Review type">{review.reviewType}</DescriptionItem>
