    ...
    <>
      ...
      <div className="ttahub-resource-use-sparkline overflow-x-scroll">
        <div className="ttahub-resource-use-sparkline__heading-group ">
          <span className="ttahub-resource-use-sparkline__resource-heading display-flex height-full flex-align-center usa-prose z-100 bg-white position-sticky left-0 padding-left-3 border-right border-bottom smart-hub-border-base-lighter">Resource URL</span>
        ...
        <div className="ttahub-resource-use-sparkline__graphs">
          <div className="display-flex flex-column z-100 bg-white position-sticky left-0 border-right">
            {data.resources.map((resource) => (
              <ResourceLink
                ...
                key={uniqueId('ttahub-resource-use-sparkline-resource-link')}
              />
            ))}
          </div>
          ...
          <div>
            {data.resources.map((resource) => (
              <ResourceUseSparkline
                key={uniqueId('ttahub-resource-use-sparkline-resource')}
                dataPoints={resource}
              />
            ))}
          </div>
          ...
          <span className="display-flex flex-column height-full usa-prose z-100 bg-white position-sticky border-left right-0">
            {data.resources.map((resource) => (<span className="usa-prose display-block text-bold border-bottom smart-hub-border-base-lighter padding-right-3 padding-left-2 padding-y-1" key={uniqueId('ttahub-resource-use-sparkline-resource-totals')}>{resource.total}</span>))}
          </span>
