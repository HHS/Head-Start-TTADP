...
export function StandardGoalsListTable({ data, loading, title, subtitle }) {
  ...
  return (
    <Container
      ...
      paddingY={1}
      loading={loading}
      loadingLabel="Goals list loading"
      ...
      <div className="ttahub-goal-counts-table inline-size-auto maxw-full margin-bottom-0">
        ...
        {data && data.length > 0 ? (
          <div className="usa-table-container--scrollable">
            <SimpleSortableTable data={data} columns={columns} className="width-full" />
          </div>
        ) : null}
      </div>
