...
describe('Total Hrs And Recipient Graph Widget', () => {
    ...
    const largeDataSet = [
      {
        ...
        y: [
          87.5, 209, 406.50000000000006, 439.4, 499.40000000000003, 493.6, 443.5, 555, 527.5, 428.5,
          295, 493.5, 533.5, 680.5, 694, 278, 440, 611, 761.5, 534, 495.5, 551, 338.5, 772, 211,
        ],
        // eslint-disable-next-line max-len
        month: [
          false,
      ...
      },
      {
        ...
        // eslint-disable-next-line max-len
        y: [
          509.90000000000003, 1141.8999999999994, 1199.3999999999996, 1109.6999999999998,
          1302.3999999999996, 1265.3999999999996, 1404.6, 1328, 1257.5, 1170, 1069.5, 1178, 1215.5,
          1426.5, 1219.5, 1063, 1151, 1316, 1436, 1400, 1518.5, 1353, 1238, 1202, 578,
        ],
        // eslint-disable-next-line max-len
        month: [
          false,
      ...
      },
      {
        ...
        // eslint-disable-next-line max-len
        y: [
          55, 134.5, 173, 137.5, 190, 248.8, 234.3, 230, 193.5, 187.5, 200.5, 202.5, 224.5, 299.5,
          155, 206.5, 209.5, 251.5, 234, 206, 235.5, 245, 279.5, 274.5, 155.5,
        ],
        // eslint-disable-next-line max-len
        month: [
          false,
  ...
  it('derives legend labels from trace data', async () => {
    ...
    expect(
      await screen.findByRole('checkbox', { name: 'Technical Assistance custom' })
    ).toBeInTheDocument();
  ...
  it('handles checkbox clicks', async () => {
    ...
    render(
      <LegendControl shape="circle" label="test" id="test" selected setSelected={setSelected} />
    );
