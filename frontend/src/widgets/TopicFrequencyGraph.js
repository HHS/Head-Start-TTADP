...
export function TopicFrequencyGraphWidget({
  ...
  return (
    <Container ref={widget} className="ttahub--topic-frequency-graph overflow-x-scroll" paddingX={3} paddingY={3} loading={loading} loadingLabel="Topic frequency loading">
