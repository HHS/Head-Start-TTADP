...
export default function useGoalTemplatePrompts(goalTemplateId, goalIds = [], isForActivityReport = false) {
  ...
  useDeepCompareEffectNoCheck(() => {
    async function fetchGoalTemplatePrompts() {
      try {
        ...
        const [promptsWithResponses, prompts] = await getGoalTemplatePrompts(goalTemplateId, goalIds, isForActivityReport)
