...
const defaultFlags = ['quality_assurance_dashboard', 'resources_dashboard', 'view_courses', 'communication_log']
...
const RenderRoutes = async (initialEntries, authenticated = true, userOverrides = {}, routeProps = {}, authError = null) => {
