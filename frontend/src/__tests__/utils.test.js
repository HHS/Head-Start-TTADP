  ...
  describe('when user is report creator', () => {
    ...
    it('should show "Reviewed" when submitted and some but not all approvers have approved', () => {
      const report = createMockReport({
        ...
        author: { id: mockUserId },
        approvers: [createMockApprover(4, APPROVER_STATUSES.APPROVED), createMockApprover(5, APPROVER_STATUSES.NEEDS_ACTION)],
      })
    ...
    it('should show "Submitted" when report is submitted with no approvals', () => {
      const report = createMockReport({
        calculatedStatus: REPORT_STATUSES.SUBMITTED,
        author: { id: mockUserId },
        approvers: [createMockApprover(4, APPROVER_STATUSES.NEEDS_ACTION), createMockApprover(5, APPROVER_STATUSES.NEEDS_ACTION)],
      })
    ...
    it('should show "Submitted" when report is submitted with all approvers approved', () => {
      const report = createMockReport({
        calculatedStatus: REPORT_STATUSES.SUBMITTED,
        author: { id: mockUserId },
        approvers: [createMockApprover(4, APPROVER_STATUSES.APPROVED), createMockApprover(5, APPROVER_STATUSES.APPROVED)],
      })
