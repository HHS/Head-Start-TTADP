...
import { destroy, get, put } from './index';
...
export const completeEvent = async (id, data) =>
  updateEvent(id, {
    ...data,
    data: {
      ...data.data,
...
export const suspendEvent = async (id, data) =>
  updateEvent(id, {
    ...data,
    data: {
      ...data.data,
...
export const resumeEvent = async (id, data, status) =>
  updateEvent(id, {
    ...data,
    data: {
      ...data.data,
