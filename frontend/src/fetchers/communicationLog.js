...
export const getAdditionalCommunicationLogData = async (regionId) => {
  const response = await get(
    join(communicationLogUrl, 'region', String(regionId), 'additional-data')
  );
...
export const getCommunicationLogById = async (regionId, logId) => {
  const response = await get(
    join(communicationLogUrl, 'region', String(regionId), 'log', String(logId))
  );
...
export const deleteCommunicationLogById = async (logId) =>
  destroy(join(communicationLogUrl, 'log', String(logId)));
