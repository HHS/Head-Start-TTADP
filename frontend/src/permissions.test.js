...
describe('canCreateCommunicationLog', () => {
  ...
  describe('when user has READ_WRITE_ACTIVITY_REPORTS permission', () => {
    it('should return true when user has permission in the specified region', () => {
      const user = createMockUser([createPermission(SCOPE_IDS.READ_WRITE_ACTIVITY_REPORTS, 1), createPermission(SCOPE_IDS.READ_ACTIVITY_REPORTS, 2)])
  ...
  describe('when user is an admin', () => {
    it('should return true when admin has READ_WRITE_ACTIVITY_REPORTS permission in the region', () => {
      const user = createMockUser([createPermission(SCOPE_IDS.ADMIN, 1), createPermission(SCOPE_IDS.READ_WRITE_ACTIVITY_REPORTS, 1)])
    ...
    it('should return false when admin has READ_WRITE_ACTIVITY_REPORTS in a different region', () => {
      const user = createMockUser([createPermission(SCOPE_IDS.ADMIN, 1), createPermission(SCOPE_IDS.READ_WRITE_ACTIVITY_REPORTS, 2)])
  ...
  describe('region 14 exclusion', () => {
    ...
    it('should return false for admin with READ_WRITE_ACTIVITY_REPORTS permission in region 14', () => {
      const user = createMockUser([createPermission(SCOPE_IDS.ADMIN, 14), createPermission(SCOPE_IDS.READ_WRITE_ACTIVITY_REPORTS, 14)])
