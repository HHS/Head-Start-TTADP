...
describe('helpers', () => {
  ...
  describe('formatObjectiveLinks', () => {
    const mockResources = [{ value: 'http://example.com/resource1' }, { value: 'http://example.com/resource2' }]

    const mockOtherEntityResources = [{ url: 'http://example.com/other1' }, { url: 'http://example.com/other2' }]
