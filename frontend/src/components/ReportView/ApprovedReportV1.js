...
import { reportDataPropTypes, formatSimpleArray, mapAttachments, formatRequester } from './helpers'
  ...
  return (
    <>
      <Container className="ttahub-activity-report-view margin-top-2">
        ...
        />
        <ViewTable caption="TTA Provided" headings={[...goalsAndObjectiveHeadings]} data={[...goalsAndObjectives]} />
        <ViewTable
          caption="Next steps"
