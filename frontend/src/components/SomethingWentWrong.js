...
const IntoTheUnknown = () => (
  <div>
    <p className="usa-prose">
      Well, this is awkward. It seems like the page you&apos;re looking for has taken a detour into
      the unknown. Here&apos;s what you can do:
    </p>
...
const Forbidden = () => (
  <div>
    <p className="usa-prose">
      Sorry, but it looks like you&apos;re trying to access a restricted area. Here&apos;s what you
      can do:
    </p>
    <ul className="usa-list">
      <li>
        <strong>Double-check permissions:</strong> Ensure you have the proper clearance to access
        this page
        <div>
      ...
      <li>
        <strong>Explore elsewhere:</strong> Return to the main area and explore other permitted
        sections.
      </li>
    </ul>
    <p className="usa-prose">
