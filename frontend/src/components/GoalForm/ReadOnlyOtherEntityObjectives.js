...
export default function ReadOnlyOtherEntityObjectives({ onEdit, hideEdit, objectives }) {
  let menuItems
  if (!hideEdit) {
    menuItems = [
      {
  ...
  return (
    <div className="ttahub-goal-form-goal-summary padding-4 margin-y-4 position-relative">
      ...
      <div className="position-absolute pin-top pin-right padding-4">
        {!hideEdit ? <ContextMenu label="Actions for Objectives" menuItems={menuItems} menuClassName="width-card" /> : null}
      </div>
