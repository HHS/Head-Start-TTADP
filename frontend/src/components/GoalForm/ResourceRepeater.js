...
import { FormGroup, Label, Button, Fieldset, ErrorMessage } from '@trussworks/react-uswds'
...
export default function ResourceRepeater({ resources, setResources, error, validateResources, toolTipText, isLoading }) {
      ...
      <FormGroup error={!!error || showNoResourcesError}>
        <div>
          <Fieldset>
            ...
            <span className="usa-hint">Enter one resource per field. To enter more resources, select “Add new resource”</span>
          </Fieldset>
          <ErrorMessage>
            {error}
