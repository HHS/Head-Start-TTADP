...
const ReportFileUploader = ({ onChange, files, idKey, idValue, id, setErrorMessage, deleteFile }) => {
  ...
  return (
    <>
      ...
      <FileTable onFileRemoved={onFileRemoved} files={files.map((f) => ({ ...f, showDelete: true }))} />
    </>
  )
}
