...
export default function ObjectiveSupportType({ supportType, onChangeSupportType, onBlurSupportType, inputName, error }) {
  ...
  return (
    <FormGroup error={hasError}>
      ...
      <div className="display-flex">
        ...
        <DrawerTriggerButton drawerTriggerRef={supportTypeDrawerTriggerRef}>Get help choosing a support type</DrawerTriggerButton>
      </div>
      {error}
      <Dropdown onChange={(e) => onChangeSupportType(e.target.value)} id={inputName} name={inputName} onBlur={onBlurSupportType} value={supportType}>
