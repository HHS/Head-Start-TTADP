...
export default function ReportsTable({
  ...
  return (
    <Container className="landing inline-size-auto maxw-full position-relative" paddingX={0} paddingY={0} loading={loading} loadingLabel="Training reports table loading">
      <TableHeader
        title={tableCaption}
        ...
        <Table fullWidth striped stackedStyle="default">
          ...
          <thead>
            <tr>
              ...
              {renderColumnHeader('Event ID', 'eventId')}
              {renderColumnHeader('Event title', 'eventName')}
              {renderColumnHeader('Session name', 'sessionName')}
              {renderColumnHeader('Session start date', 'startDate')}
              {renderColumnHeader('Session end date', 'endDate')}
