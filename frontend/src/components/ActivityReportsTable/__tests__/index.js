...
describe('ActivityReportsTable', () => {
  describe('Table menus & selections', () => {
    ...
    describe('Table row context menu', () => {
      ...
      beforeEach(async () => {
        fetchMock.reset()
        fetchMock.get(defaultBaseUrlWithRegionOne, convertToResponse(generateXFakeReports(10, ['approved'])))
        const user = {
          name: 'test@test.com',
          homeRegionId: 1,
          permissions: [
  ...
  describe('Table sorting', () => {
    ...
    it('clicking on the second page updates to, from and total', async () => {
      fetchMock.reset()
      fetchMock.get(defaultBaseUrlWithRegionOne, convertToResponse(generateXFakeReports(10), false, 17))
      const user = {
        name: 'test@test.com',
        homeRegionId: 14,
        permissions: [
