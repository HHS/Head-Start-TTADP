...
describe('ParticipantsNumberOfParticipants', () => {
  const TestComponent = ({ isHybrid, isDeliveryMethodSelected }) => {
    ...
    return (
      <FormProvider {...hookForm}>
        <ParticipantsNumberOfParticipants isHybrid={isHybrid} isDeliveryMethodSelected={isDeliveryMethodSelected} register={hookForm.register} />
      </FormProvider>
    )
  }
  ...
  const renderTest = (isHybrid, isDeliveryMethodSelected) => {
    render(<TestComponent isHybrid={isHybrid} isDeliveryMethodSelected={isDeliveryMethodSelected} />)
  }
