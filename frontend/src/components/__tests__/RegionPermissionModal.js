...
const PermissionModal = ({ filters = defaultFilters, user = defaultUser, showFilterWithMyRegions = () => {} }) => (
  <div>
    <RegionPermissionModal filters={filters} user={user} showFilterWithMyRegions={showFilterWithMyRegions} />
  </div>
)
