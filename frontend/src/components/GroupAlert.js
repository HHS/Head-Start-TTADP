  ...
  return (
    <>
      <USWDSAlert type="info">
        You&apos;ve successfully modified the group&apos;s recipients for this report. Changes here
        do not affect the group itself.
        <button
          type="button"
          className="smart-hub-activity-summary-group-info usa-button usa-button--unstyled"
          onClick={resetGroup}
        >
