...
const { READ_ACTIVITY_REPORTS, ADMIN, UNLOCK_APPROVED_REPORTS } = SCOPE_IDS

describe('UserPermissions', () => {
  describe('with no permissions', () => {
    beforeEach(() => {
      render(
        <UserPermissions regionalPermissions={{}} globalPermissions={{}} onRegionalPermissionChange={() => {}} onGlobalPermissionChange={() => {}} />
      )
    })
