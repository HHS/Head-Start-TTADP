import { Button, ButtonGroup, Form, FormGroup, Label, TextInput } from '@trussworks/react-uswds';
      ...
      <Form onSubmit={onSubmit} className="margin-bottom-2">
        <details>
          ...
          <p className="usa-prose">
            The CSS class is used to style the feed preview by the engineers. The option to add it
            here is so that you can preview changes to existing feeds. (It won&apos;t do anything
            unless an engineer has already added corresponding styles.)
          </p>
        </details>
        <FormGroup>
