  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route path="/admin/national-centers/:nationalCenterId?" render={({ match }) => <NationalCenters match={match} />} />
        <Route path="/admin/goals/" render={() => <Goals />} />
        <Route path="/admin/training-reports/" render={({ match }) => <TrainingReports match={match} />} />
        <Route path="/admin/courses/" render={({ match }) => <Courses match={match} />} />
        <Route path="/admin/course/:courseId" render={({ match }) => <CourseEdit match={match} />} />
