...
import { createRegionalCommunicationLog, updateCommunicationLogById } from '../../fetchers/communicationLog'
import LogFormNavigator from '../../components/CommunicationLog/components/LogFormNavigator'
import AppLoadingContext from '../../AppLoadingContext'
import UserContext from '../../UserContext'

export const shouldFetch = ({ communicationLogId, regionId, reportFetched, isAppLoading, currentPage }) => {
  if (
    !currentPage || // we
      ...
      <Grid row className="flex-justify">
        <Grid col="auto">
          <div className="margin-top-3 margin-bottom-5">
            <h1 className="font-serif-2xl text-bold line-height-serif-2 margin-0">Communication log - your region</h1>
          </div>
        </Grid>
      </Grid>
