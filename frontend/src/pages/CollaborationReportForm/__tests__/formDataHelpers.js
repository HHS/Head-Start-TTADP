import { findWhatsChanged, unflattenResourcesUsed, convertReportToFormData } from '../formDataHelpers'
...
describe('formDataHelpers', () => {
  ...
  describe('unflattenResourcesUsed', () => {
    it('should convert array of values to array of objects', () => {
      ...
      expect(result).toEqual([{ value: 'resource1' }, { value: 'resource2' }, { value: 'resource3' }])
    })
    ...
    it('should handle mixed data types', () => {
      ...
      expect(result).toEqual([{ value: 'string' }, { value: 123 }, { value: true }, { value: null }])
    })
  })
