...
function RecipientCard({
  ...
  return (
    <>
      <article
        className="ttahub-recipient-card usa-card padding-3 radius-lg border width-full maxw-full smart-hub-border-base-lighter margin-bottom-2 position-relative"
      ...
      >
        <div className="ttahub-recipient-card__row position-relative">
          ...
          <div className="ttahub-recipient-card__recipient-column ttahub-recipient-card__recipient-column__title padding-right-3">
            ...
            <p className="usa-prose margin-y-0">{recipient.name}</p>
          </div>
