...
describe('GoalCard', () => {
  ...
  const renderGoalCard = async (recipient, handleGoalCheckboxSelect = jest.fn(), isChecked = false, zIndex = 100) => {
    render(
      <Router history={history}>
        <RecipientCard recipient={recipient} handleGoalCheckboxSelect={handleGoalCheckboxSelect} isChecked={isChecked} zIndex={zIndex} />
      </Router>
    )
  }
