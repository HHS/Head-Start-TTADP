...
export default function ActivityReportDashboard({ filtersToApply, resetPagination, setResetPagination, filterKey }) {
  return (
    <>
      <Helmet>
      ...
      <DashboardOverview
        ...
        fields={['Recipients served', 'Grants served', 'Activity reports', 'Participants', 'Hours of TTA']}
        showTooltips
      />
