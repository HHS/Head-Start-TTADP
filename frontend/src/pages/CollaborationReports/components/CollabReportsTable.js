...
const CollabReportsTable = ({ emptyMsg, loading, showCreateMsgOnEmpty, title, data, requestSort, sortConfig, setSortConfig }) => {
      ...
      >
        ...
        {data.rows.length > 0 && (
          <HorizontalTableWidget
            headers={['Activity name', 'Date started', 'Creator', 'Created date', 'Collaborators', 'Last saved']}
            data={tabularData}
