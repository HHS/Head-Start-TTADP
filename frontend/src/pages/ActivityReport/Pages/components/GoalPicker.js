...
const GoalPicker = ({ grantIds, reportId, goalTemplates }) => {
  ...
  const isMonitoringGoal = goalForEditing && goalForEditing.standard && goalForEditing.standard === 'Monitoring'
  ...
  useDeepCompareEffect(() => {
    ...
    if (isMonitoringGoal && (!selectedGoals || selectedGoals.length === 0)) {
      ...
      if (monitoringGoal) {
        ...
        const missingGrants = grantIds.filter((grantId) => !monitoringGoal.goals.find((g) => g.grantId === grantId))
  ...
  }, [goalForEditing, grantIds, selectedGoals, activityRecipients, isMonitoringGoal, goalTemplates])
      ...
      <div className="position-relative">
        ...
        <div data-testid="goal-selector">
          <Select
            ...
            options={goalTemplates.filter((goal) => !selectedGoals?.some((s) => s.goalTemplateId === goal.goalTemplateId))}
            styles={{
              ...selectOptionsReset,
              option: (provided) => ({
                ...provided,
