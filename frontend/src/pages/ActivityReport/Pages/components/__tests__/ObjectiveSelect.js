...
const RenderObjectiveSelect = ({
  ...
  options,
  onRemove = () => {},
}) => <ObjectiveSelect onChange={() => {}} selectedObjectives={selectedObjectives} options={options} onRemove={onRemove} />

describe('ObjectiveSelect', () => {
  it('renders', async () => {
    render(<RenderObjectiveSelect options={[]} selectedObjectives={[]} />)
  ...
  it('the "Remove" button in the modal calls the onRemove prop', async () => {
    ...
    render(<RenderObjectiveSelect options={[]} selectedObjectives={[]} onRemove={onRemove} />)
    screen.getByText('Remove this objective').click()
