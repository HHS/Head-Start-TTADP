...
const RenderObjectiveFormItem = ({
  ...
  <ObjectiveFormItem showErrors={!isValid} className="margin-top-0" message="objective form item required" label="Objective" value={formItemValue}>
    <TextInput name="text-input-name" aria-label="text-input-label" onChange={onChange} value={formItemValue} />
  </ObjectiveFormItem>
)
