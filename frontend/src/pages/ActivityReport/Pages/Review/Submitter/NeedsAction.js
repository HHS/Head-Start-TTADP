...
import { FormGroup, Button, Fieldset, Dropdown, ErrorMessage } from '@trussworks/react-uswds'
...
const NeedsAction = ({
  ...
  return (
    <>
        ...
        {!userHasOneRole ? (
          <>
            ...
            <FormGroup error={showCreatorRoleError}>
              <Fieldset>
                {showCreatorRoleError ? <ErrorMessage>Please select a creator role.</ErrorMessage> : null}
                <Dropdown id="creatorRole" name="creatorRole" value={submitCR} onChange={creatorRoleChange}>
      ...
      <Fieldset className="smart-hub--report-legend margin-top-4 smart-hub--report-legend__no-legend-margin-top no-print" legend="Additional Notes">
