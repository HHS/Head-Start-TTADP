...
const RenderNextSteps = ({
  ...
  return (
    <FormProvider {...hookForm}>
      {nextSteps.render(null, { activityRecipientType }, 1, null, jest.fn(), jest.fn(), jest.fn(), false, '', jest.fn(), () => (
        <></>
      ))}
    </FormProvider>
  )
...
const RenderReview = ({
  ...
  return <FormProvider {...hookForm}>{nextSteps.reviewSection(activityRecipientType)}</FormProvider>
}

const renderNextSteps = (specialist = [], recipient = [], activityRecipientType = 'recipient') => {
  render(<RenderNextSteps specialistNextSteps={specialist} recipientNextSteps={recipient} activityRecipientType={activityRecipientType} />)
}

const renderReviewNextSteps = (specialist = [], recipient = [], activityRecipientType = 'recipient') => {
  render(<RenderReview specialistNextSteps={specialist} recipientNextSteps={recipient} activityRecipientType={activityRecipientType} />)
}
