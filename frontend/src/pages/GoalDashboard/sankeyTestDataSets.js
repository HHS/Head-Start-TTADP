...
const typical = {
  ...
  reasonRows: [
    ...
    },
    {
      status: 'Suspended',
      statusLabel: 'Suspended',
      reason: 'Recipient is not responding',
      count: 1,
      percentage: 50,
    },
  ],
  sankey: {
    nodes: [
      ...
      {
        id: 'reason:Closed:Recipient request',
      ...
      {
        id: 'reason:Suspended:Recipient is not responding',
        label: 'Recipient is not responding',
        count: 1,
        percentage: 50,
      },
    ],
    links: [
      ...
      {
        source: 'status:Suspended',
        target: 'reason:Suspended:Recipient is not responding',
        value: 1,
      },
    ],
  },
...
const denseReasons = {
  ...
  sankey: {
    nodes: [
      ...
      {
        id: 'reason:Closed:Recipient is not responding',
        label: 'Recipient is not responding',
        count: 3,
        percentage: 10,
      },
