...
export default function Group({ match }) {
  ...
  return (
    <>
      ...
      <WidgetCard header={<h1 className="margin-top-2 margin-bottom-4 font-serif-xl">{group.name}</h1>}>
        <ReadOnlyField label="Group owner">{group && group.creator ? group.creator.name : ''}</ReadOnlyField>
