...
const handleArrayJoin = (arr, join = ', ', alt = 'None provided') =>
  arr && arr.length ? arr.join(join) : alt;
      ...
      ? [
          {
            ...
            data: {
              ...
              ...(!organizerIsNoNationalCenters
                ? { 'Regional point of contact': handleArrayJoin(eventPoc) }
                : {}),
            ...
            sections={[
              ...
              },
              {
                ...
                data: {
                  ...
                  'Resource attachments':
                    session.data.files && session.data.files.length
              ...
              },
              {
                ...
                data: {
                  ...
                  'TTA type': handleArrayJoin(
                    (session.data.ttaType || []).map((t) => capitalize(t).replace(/-/g, ' '))
                  ),
