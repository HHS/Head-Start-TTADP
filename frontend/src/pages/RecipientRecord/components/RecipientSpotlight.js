...
export default function RecipientSpotlight({ regionId, recipientId, grantId, grantNumber }) {
  ...
  const numberOfTrueIndicators = spotlightData.filter(
  ...
  return (
    <Container paddingX={0} paddingY={0} className="ttahub--recipient-summary">
      <div className="ttahub-recipient-record--card-header padding-x-3 padding-y-3 margin-bottom-0 margin-top-0">
        ...
        <p className="margin-0 padding-0 usa-prose margin-top-1">
          This is the grant&apos;s current number of priority indicators.
        </p>
      </div>

      {hasResults ? (
        // biome-ignore lint/a11y/noNoninteractiveTabindex: Allows keyboard users to scroll the spotlight content.
                    ...
                    <div className="display-flex flex-column">
                      <b>
                        ...
                        <span className="usa-sr-only">
                          {indicator.value
                            ? ' - Active indicator'
                            : ' - Not applicable to this recipient'}
                        </span>
                      </b>
        ...
        <div className="ttahub-recipient-spotlight-content padding-3 overflow-y-auto">
          <NoResultsFound
            customMessage="There are no current priority indicators for this recipient."
            hideFilterHelp
          />
        </div>
      )}
