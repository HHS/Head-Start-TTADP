        ...
        activityReportObjectives: [
          {
            ...
            activityReportObjectiveCourses: [{ course: { id: 301, name: 'Early Childhood Development Course' } }],
          },
          {
...
describe('ViewGoalDetails', () => {
  ...
  test('renders objective information including reports, topics, and resources', async () => {
    ...
    const files = within(resourcesContainer).getAllByText(
      (content, element) =>
        ['report101-file1.pdf', 'report101-file2.docx', 'report102-file1.xlsx'].includes(content) && element.tagName.toLowerCase() === 'li'
    )
