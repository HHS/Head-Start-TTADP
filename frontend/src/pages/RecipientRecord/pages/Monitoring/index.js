  ...
  return (
    <Container className="maxw-full position-relative" paddingX={0} paddingY={0} positionRelative>
      ...
      <div className="padding-x-3 padding-y-2">
        {currentPage === MONITORING_PAGES.REVIEW && <ReviewCards data={byReview} regionId={Number(regionId)} />}
        {currentPage === MONITORING_PAGES.CITATION && <CitationCards data={byCitation} regionId={Number(regionId)} />}
      </div>
    </Container>
  )
}
