...
describe('Monitoring', () => {
  ...
  const citationUrl = join(monitoringUrl, String(recipientId), 'region', String(regionId), 'tta', 'citation')

  const reviewUrl = join(monitoringUrl, String(recipientId), 'region', String(regionId), 'tta', 'review')
