...
describe('Goals and Objectives', () => {
  ...
  it('resets the page number when filters change', async () => {
    ...
    fetchMock.get(
      ...
      {
        count: 11,
        allGoalIds: [{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }, { id: 6 }, { id: 7 }, { id: 8 }, { id: 9 }, { id: 10 }, { id: 11 }],
        goalRows: [
  ...
  it('will sort by the dropdown', async () => {
    ...
    fetchMock.get('/api/recipient/401/region/1/goals?sortBy=createdOn&sortDir=asc&offset=0&limit=10', {
      count: 1,
      goalRows: goals,
      statuses: defaultStatuses,
    })
