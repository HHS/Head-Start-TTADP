...
export const getGoalsAndObjectivesFilterConfig = (grantNumberParams) =>
  [createDateFilter, goalNameFilter, grantNumberFilter(grantNumberParams), reasonsFilter, statusFilter, topicsFilter, userRolesFilter].sort((a, b) =>
    a.display.localeCompare(b.display)
  )

const TTAHISTORY_FILTER_CONFIG = [startDateFilter, endDateFilter, activityReportGoalResponseFilter, myReportsFilter, specialistRoleFilter]
