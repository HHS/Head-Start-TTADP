...
const BadgeCompliant = () => <span className="ttahub-badge--success font-sans-2xs text-white text-bold">Compliant</span>

const BadgeNoncompliant = (text = 'Noncompliant') => <span className="ttahub-badge--error font-sans-2xs text-white text-bold">{text}</span>
    ...
    <Container paddingX={0} paddingY={0} className="smart-hub--overflow-auto">
      <div className="ttahub-recipient-record--card-header padding-x-3 padding-y-3 margin-bottom-0 margin-top-0">
        <div className="display-flex flex-row flex-justify">
          ...
          >
            HSES monitoring <FontAwesomeIcon icon={faExternalLinkAlt} size="sm" className="margin-left-1" />
          </Link>
        </div>
      </div>
