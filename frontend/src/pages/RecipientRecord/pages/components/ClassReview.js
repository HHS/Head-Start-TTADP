  ...
  return (
    <Container paddingX={0} paddingY={0} className="smart-hub--overflow-auto">
      <Drawer triggerRef={howMetRef} stickyHeader stickyFooter title="CLASS® review thresholds">
        <ContentFromFeedByTag tagName="ttahub-class-thresholds" contentSelector="div:nth-child(3)" className="ttahub-class-feed-article" />
        <ContentFromFeedByTag tagName="ttahub-class-thresholds" contentSelector="div:nth-child(4)" className="ttahub-class-feed-article" />
      </Drawer>
      <div className="ttahub-recipient-record--card-header padding-x-3 padding-y-3 margin-bottom-0 margin-top-0">
        <div className="display-flex flex-row flex-justify">
          ...
          >
            HSES CLASS <FontAwesomeIcon icon={faExternalLinkAlt} size="sm" className="margin-left-1" />
          </Link>
        </div>
        <div className="margin-top-2">
          <button type="button" className="usa-button usa-button--unstyled font-sans-xs" ref={howMetRef}>
      ...
      <div className="padding-x-3 padding-bottom-2">
        ...
        {scores.received && (
          <div className="margin-y-2">
            ...
            <p className="margin-y-1">{scores.received}</p>
          </div>
        )}
        ...
        {scores.ES && (
          <div className="margin-y-2" data-testid="class-es">
            ...
            <p className="margin-0">{scores.ES}</p>
          </div>
        )}
        ...
        {scores.CO && (
          <div className="margin-y-2" data-testid="class-co">
            ...
            <p className="margin-0">{scores.CO}</p>
          </div>
        )}
        ...
        {scores.IS && (
          <div className="margin-y-2" data-testid="class-is">
            ...
            <p className="margin-0">{scores.IS}</p>
          </div>
        )}
      </div>
    </Container>
