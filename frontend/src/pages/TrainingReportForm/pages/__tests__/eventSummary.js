...
describe('eventSummary', () => {
  ...
  describe('render', () => {
    ...
    const RenderEventSummary = ({ user = defaultUser, creators = defaultCreators, defaultValues = defaultFormValues }) => {
    ...
    it('admin users can edit all fields', async () => {
      ...
      expect(
        await screen.findByRole('combobox', { name: /target populations addressed required target population1 target population2/i })
      ).toBeInTheDocument()
