...
export const LOCAL_STORAGE_ADDITIONAL_DATA_KEY = (id) =>
  `tr-additional-data-${id}-${LOCAL_STORAGE_CACHE_NUMBER}`;
...
export const pageTouched = (touched, fields) =>
  Object.keys(touched).filter((error) => fields.includes(error)).length > 0;
