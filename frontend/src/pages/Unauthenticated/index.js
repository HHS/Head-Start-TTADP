      ...
      >
        <div className="maxw-mobile margin-x-auto padding-y-7">
          <img
            ...
            className="smart-hub-logo display-block margin-x-auto"
          />
          ...
          <div className="text-center margin-top-4">
            <p id="login-description">You must log in with HSES in order to access the Office of Head Start TTA Hub.</p>
            <Link
              referrerPolicy="strict-origin-when-cross-origin"
              className="usa-button display-block margin-x-1 margin-top-4"
              variant="unstyled"
              href="/api/login"
            >
              Log In with HSES
