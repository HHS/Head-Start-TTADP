...
All four tables are created by migration `20260901150000-create_validation_tables.js`. Ids are `INTEGER` autoincrement; `createdAt`/`updatedAt` are present on every table.
...
- **Migration**: `src/migrations/20260901150000-create_validation_tables.js`
