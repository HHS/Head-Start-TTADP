...
export default (sequelize, DataTypes) => {
  class SessionReportPilotSupportingAttachment extends Model {
    static associate(models) {
      SessionReportPilotSupportingAttachment.belongsTo(models.SessionReportPilot, { foreignKey: 'sessionReportPilotId', as: 'sessionReport' });
      SessionReportPilotSupportingAttachment.belongsTo(models.File, { foreignKey: 'fileId', as: 'file' });
    }
  }
